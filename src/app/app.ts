...
const TECH_ICONS: Record<string, TechMeta> = {
  ...
  html5: { abbr: '5', bg: '#e34f26', fg: '#ffffff' },
  ...
  git: { abbr: 'Git', bg: '#f05032', fg: '#ffffff' },
  bitbucket: { abbr: 'Bit', bg: '#0052cc', fg: '#ffffff' },
  sonarqube: { abbr: 'SQ', bg: '#4e9bcd', fg: '#ffffff' },
  docker: { abbr: 'Dk', bg: '#2496ed', fg: '#ffffff' },
  ...
  php: { abbr: 'PHP', bg: '#777bb4', fg: '#ffffff' },
  laravel: { abbr: 'Lv', bg: '#ff2d20', fg: '#ffffff' },
  'azure/cloud computing': { abbr: 'Az', bg: '#0089d6', fg: '#ffffff' },
